        ...
        private void HomepageMarketGet(ModLoader.LoaderTask<bool, string> Task)
        {
            try
            {
                ...
                ModBase.RunInUi(() =>
                {
                    ...
                    var element = ModBase.GetObjectFromXML($"<StackPanel xmlns='http://schemas.microsoft.com/winfx/2006/xaml/presentation' xmlns:x='http://schemas.microsoft.com/winfx/2006/xaml' xmlns:local='clr-namespace:PCL;assembly=PCL' xmlns:sys='clr-namespace:System;assembly=System.Runtime'>{content}</StackPanel>") as UIElement;
